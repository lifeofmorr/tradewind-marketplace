...
with photo_bank as (
  select * from (values
    ...
    ('center_console', 3, 'https://images.unsplash.com/photo-1502209524164-acea936639a2?w=800&q=80&auto=format&fit=crop'),
    ('center_console', 4, 'https://images.unsplash.com/photo-1544551763-77ef2d0cfc6c?w=800&q=80&auto=format&fit=crop'),

    ('performance_boat', 0, 'https://images.unsplash.com/photo-1510707577719-ae7c14805e3a?w=800&q=80&auto=format&fit=crop'),
    ('performance_boat', 1, 'https://images.unsplash.com/photo-1501761095094-94d36f57edbb?w=800&q=80&auto=format&fit=crop'),
    ...
    ('boat', 0, 'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?w=800&q=80&auto=format&fit=crop'),
    ...
    ('car', 2, 'https://images.unsplash.com/photo-1494976388531-d1058494cdd8?w=800&q=80&auto=format&fit=crop'),
    ('car', 3, 'https://images.unsplash.com/photo-1502877338535-766e1452684a?w=800&q=80&auto=format&fit=crop'),
    ...
    ('truck', 4, 'https://images.unsplash.com/photo-1547038577-da80abbc4f19?w=800&q=80&auto=format&fit=crop'),
    ...
    ('exotic', 2, 'https://images.unsplash.com/photo-1553440569-bcc63803a83d?w=800&q=80&auto=format&fit=crop'),
    ('exotic', 3, 'https://images.unsplash.com/photo-1502877338535-766e1452684a?w=800&q=80&auto=format&fit=crop'),
    ('exotic', 4, 'https://images.unsplash.com/photo-1544636331-e26879cd4d9b?w=800&q=80&auto=format&fit=crop'),
