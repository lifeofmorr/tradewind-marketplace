...
const CATEGORY_TO_SERVICE: Record<ListingCategory, ServiceCategory[]> = {
  ...
  aircraft_single_engine: ["ap_mechanic", "ia_inspector", "aviation_maintenance_shop", "avionics_shop", "aviation_insurance", "aircraft_lender", "aircraft_escrow", "aircraft_title_company", "ferry_pilot", "hangar_storage"],
  aircraft_twin_engine: ["ap_mechanic", "ia_inspector", "aviation_maintenance_shop", "avionics_shop", "aviation_insurance", "aircraft_lender", "aircraft_escrow", "aircraft_title_company", "ferry_pilot", "hangar_storage"],
  aircraft_turboprop: ["ap_mechanic", "ia_inspector", "aviation_maintenance_shop", "avionics_shop", "aviation_insurance", "aircraft_lender", "aircraft_escrow", "aircraft_title_company", "ferry_pilot", "hangar_storage", "aircraft_broker"],
  aircraft_very_light_jet: ["ap_mechanic", "ia_inspector", "aviation_maintenance_shop", "avionics_shop", "aviation_insurance", "aircraft_lender", "aircraft_escrow", "aircraft_title_company", "ferry_pilot", "hangar_storage", "aircraft_broker"],
  aircraft_jet: ["ap_mechanic", "ia_inspector", "aviation_maintenance_shop", "avionics_shop", "aviation_insurance", "aircraft_lender", "aircraft_escrow", "aircraft_title_company", "ferry_pilot", "hangar_storage", "aircraft_broker"],
  aircraft_helicopter: ["ap_mechanic", "ia_inspector", "aviation_maintenance_shop", "avionics_shop", "aviation_insurance", "aircraft_lender", "aircraft_escrow", "aircraft_title_company", "ferry_pilot", "hangar_storage"],
  aircraft_vintage: ["ap_mechanic", "ia_inspector", "aviation_maintenance_shop", "aviation_insurance", "aircraft_escrow", "aircraft_title_company", "hangar_storage"],
  aircraft_experimental: ["ap_mechanic", "avionics_shop", "aviation_insurance", "ferry_pilot", "hangar_storage"],
  aircraft_amphibious: ["ap_mechanic", "ia_inspector", "aviation_maintenance_shop", "aviation_insurance", "ferry_pilot", "hangar_storage"],
  aircraft_lsa: ["ap_mechanic", "aviation_maintenance_shop", "aviation_insurance", "ferry_pilot", "hangar_storage"],
  aircraft_parts: ["aviation_maintenance_shop", "avionics_shop", "transport"],
  aviation_services: ["aviation_maintenance_shop", "ap_mechanic", "ia_inspector", "avionics_shop", "ferry_pilot"],
};
